...
if gpu then
  ...
  local bgf = component.invoke(computer.getBootAddress(), "open", "/etc/arch/colorscheme/bg")
  local fgf = component.invoke(computer.getBootAddress(), "open", "/etc/arch/colorscheme/fg")
  local bg = component.invoke(computer.getBootAddress(), "read", bgf, math.huge)
  local fg = component.invoke(computer.getBootAddress(), "read", fgf, math.huge)
  component.invoke(computer.getBootAddress(), "close", bgf)
  component.invoke(computer.getBootAddress(), "close", fgf)

  bg, fg = tonumber(bg or "0x000000"), tonumber(fg or "0xffffff")
